...
def test_add_indent():
    sample = "def hello():\n    return 'Hello, World!'"
    result = _code_module.add_indent(sample, 4)
    expected = "    def hello():\n        return 'Hello, World!'"
...
def test_get_tab_spaces():
    sample = "def test():\n    print('test')\n    if True:\n        print('nested')"
    assert _code_module.get_tab_spaces(sample) == 4
    sample = "def test():\n  print('test')\n  if True:\n    print('nested')"
    assert _code_module.get_tab_spaces(sample) == 2
...
def test_change_tab_size():
    ...
    sample = "def test():\n    print('test')"
    assert _code_module.change_tab_size(sample, 4) == sample
    sample = "def test():\n  print('test')\n\n  if True:\n    print('nested')"
    expected = "def test():\n    print('test')\n    if True:\n        print('nested')"
...
def test_get_func_calls():
    ...
    assert not _code_module.get_func_calls("no function calls here")
...
function test() {
    ...
    assert _code_module.is_js(js_sample, funcs={"customFunc"}) is True
    assert _code_module.is_js(js_sample) is False

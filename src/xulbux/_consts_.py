...
class ANSI:
    ...
    codes_map: dict[str | tuple[str], int] = {
        ...
        ("background:black", "bg:black"): 40,
        ("background:red", "bg:red"): 41,
        ("background:green", "bg:green"): 42,
        ("background:yellow", "bg:yellow"): 43,
        ("background:blue", "bg:blue"): 44,
        ("background:magenta", "bg:magenta"): 45,
        ("background:cyan", "bg:cyan"): 46,
        ("background:white", "bg:white"): 47,
